...
Palace.POI = {"vetinari": "Ah, hello officer. Impeccable timing. Both the city and I would be most grateful if you were to assist me in apprehending this pretender to the patricianship, and restore the steady ticking of order to the machine otherwise known as Ankh-Morpork."}
Palace.Items = {"arms":0}
Palace.boss = True
Palace.sprite = False
...
Post_Office_Basement.POI = {"moist": "He damn near killed old Mr Groat. Thank you so much for defeating him. As a gift, take some money."}
