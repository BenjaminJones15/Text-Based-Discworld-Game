...
Library.POI = {"librarian":"Ook, Ook. - Translation - Excellent, another watch officer. Commander Vimes is currently on the roof facing the criminal, and will be grateful for backup."}
Library.Items = {}
Library.boss = False
Library.sprite = True
